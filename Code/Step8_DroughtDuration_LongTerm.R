...
saveRDS(DroughtDurationAnnual, (file.path(file_Path_Variable_O,"DroughtDurationAnnual_Step8_LongTerm.rds")))
saveRDS(average_annual_Drought_Duration_DF, (file.path(file_Path_Variable_O,"average_annual_Drought_Duration_DF_Step8_LongTerm..rds")))
saveRDS(AnnualTrendDroughtDuration, (file.path(file_Path_Variable_O,"AnnualTrendDroughtDuration_Step8_LongTerm.rds")))
...
for (Threshold in thresholds) {
  for (Type in types) {
    ...
    # Save the final plot
    ggsave(filename = paste0(file_Path_Variable_O, "/Step8output/LongTerm/Step8_FinalPlot_", Threshold, "_", Type, ".jpg"),
           plot = FinalPlot,

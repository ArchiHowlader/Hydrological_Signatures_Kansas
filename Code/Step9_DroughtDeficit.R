...
ggsave(filename = (file.path(file_Path_Variable_O,"Step9_DroughtDeficit_Threshold2_F.jpg")), 
...
ggsave(filename = file.path(file_Path_Variable_O, "Combined_Fixed_Thresholds_Step8.jpg"), 
       plot = combined_fixed_plots, width = 20, height = 12, dpi = 300)

ggsave(filename = file.path(file_Path_Variable_O, "Combined_Variable_Thresholds_Step8.jpg"), 

...
AllYear_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "AllYear_StreamflowData_Annual_Min7_step7.rds"))
MediumTerm_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_step7.rds"))
LongTerm_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "LongTerm_StreamflowData_Annual_Min7_step7.rds"))



AllYear_StreamflowData_Annual_max7<- AllYear_StreamflowData_Annual %>% 
  left_join(Annual_max_7DayStreamflow, by=c('site_no','Year'))
AllYear_StreamflowData_Annual_max7




MediumTerm_StreamflowData_Annual_max7<- MediumTerm_StreamflowData_Annual %>% 
  left_join(MediumTerm_max_7DayStreamflow, by=c('site_no','Year'))
MediumTerm_StreamflowData_Annual_max7



LongTerm_StreamflowData_Annual_max7<- LongTerm_StreamflowData_Annual %>% 
  left_join(LongTerm_max_7DayStreamflow, by=c('site_no','Year'))
LongTerm_StreamflowData_Annual_max7


length(unique(LongTerm_StreamflowData_Annual_max7$site_no))
length(unique(MediumTerm_StreamflowData_Annual_max7$site_no))





saveRDS(AllYear_StreamflowData_Annual_max7,file.path(file_Path_Variable_O, "AllYear_StreamflowData_Annual_Min7_Max7_step7.rds"))
saveRDS(MediumTerm_StreamflowData_Annual_max7,file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_Max7_step7.rds"))
saveRDS(LongTerm_StreamflowData_Annual_max7,file.path(file_Path_Variable_O, "LongTerm_StreamflowData_Annual_Min7_Max7_step7.rds"))
# 

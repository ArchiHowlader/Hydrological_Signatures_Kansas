...
for (Threshold in thresholds) {
  for (Type in types) {
    ...
    ggsave(filename = file.path(file_Path_Variable_O, paste0("Step9_DroughtDeficit_Threshold_Medium_MMD", Threshold, "_", Type, ".jpg")), 
           plot = threshold_values_df_Map, width = 8, height = 6, dpi = 300)
...
ggsave(filename = file.path(file_Path_Variable_O, "Combined_Fixed_Thresholds_Step8_Medium_MMD.jpg"), 
       plot = combined_fixed_plots, width = 20, height = 12, dpi = 300)

ggsave(filename = file.path(file_Path_Variable_O, "Combined_Variable_Thresholds_Step8_Medium_MMD.jpg"), 
...
# 
MediumTerm_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_Max7Seasonal_DroughtDuration_step8.rds"))
# 
# 
MediumTerm_StreamflowData_Annual_DroughtDeficitAnnual<- MediumTerm_StreamflowData_Annual %>%
  left_join(threshold_values_df_annual_rds, by=c('site_no','Year'))
MediumTerm_StreamflowData_Annual_DroughtDeficitAnnual
# 


saveRDS(MediumTerm_StreamflowData_Annual_DroughtDeficitAnnual,file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_Max7Seasonal_DroughtDuration_DroughtDeficit_step9.rds"))
...
ggsave(filename = file.path(file_Path_Variable_O, "Step9_MMD_Mediumterm_FinalFigure.jpg"), 

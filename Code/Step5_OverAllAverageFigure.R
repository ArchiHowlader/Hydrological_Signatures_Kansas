...
maxcf<- max(overall_average_streamflow_AllYear$OverallAvgStreamflow_cfs)
mincf<- min(overall_average_streamflow_AllYear$OverallAvgStreamflow_cfs)
...
overall_average_streamflow_AllYear_Map <- ggplot() +
  ...
  geom_point(data = overall_average_streamflow_AllYear, 
             aes(x = station_lon, y = station_lat, 
                 color = OverallAvgStreamflow_cfs, 
                 size = OverallAvgStreamflow_cfs),  # Map both color and size to streamflow
             alpha = 0.8) +

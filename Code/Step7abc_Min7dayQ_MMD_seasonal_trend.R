...
calculate_kendall_tau_multiple <- function(df) {
  df %>%
    group_by(site_no) %>%
    summarise(
      Tau_Fall = Kendall(Year, Min_7DayStreamflow_Fall_MMD)$tau,    
      p_value_Fall = Kendall(Year, Min_7DayStreamflow_Fall_MMD)$sl, 
      Tau_Spring = Kendall(Year, Min_7DayStreamflow_Spring_MMD)$tau, 
      p_value_Spring = Kendall(Year, Min_7DayStreamflow_Spring_MMD)$sl, 
      Tau_Summer = Kendall(Year, Min_7DayStreamflow_Summer_MMD)$tau,  
      p_value_Summer = Kendall(Year, Min_7DayStreamflow_Summer_MMD)$sl, 
      Tau_Winter = Kendall(Year, Min_7DayStreamflow_Winter_MMD)$tau,  
      p_value_Winter = Kendall(Year, Min_7DayStreamflow_Winter_MMD)$sl  
    ) %>%
    ungroup()
}
...
ggsave(filename = file.path(file_Path_Variable_O, "MediumTermSeasonalTrendMin7_step7abc.jpg"), 
...
ggsave(filename = file.path(file_Path_Variable_O, "LongTermSeasonalTrendMin7_step7abc.jpg"), 

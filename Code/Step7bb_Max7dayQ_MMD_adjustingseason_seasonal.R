...
AllYear_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "AllYear_StreamflowData_Annual_Min7_Max7_Min7Seasonal_adjustingseason_step7.rds"))
MediumTerm_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_adjustingseason_step7.rds"))
LongTerm_StreamflowData_Annual <- readRDS(file.path(file_Path_Variable_O, "LongTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_adjustingseason_step7.rds"))


AllYear_Max_7DayStreamflow_Seasonal<- AllYear_Max_7DayStreamflow_Seasonal %>% rename(Year=adjusted_year)
MediumTerm_Max_7DayStreamflow_Seasonal<- MediumTerm_Max_7DayStreamflow_Seasonal %>% rename(Year=adjusted_year)
LongTerm_Max_7DayStreamflow_Seasonal<- LongTerm_Max_7DayStreamflow_Seasonal %>% rename(Year=adjusted_year)
...
# 
saveRDS(AllYear_StreamflowData_Annual_Max7_Seasonal,file.path(file_Path_Variable_O, "AllYear_StreamflowData_Annual_Min7_Max7_Min7Seasonal_Max7Seasonal_adjustingseason_step7.rds"))
saveRDS(MediumTerm_StreamflowData_Annual_Max7_Seasonal,file.path(file_Path_Variable_O, "MediumTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_Max7Seasonal_adjustingseason_step7.rds"))
saveRDS(LongTerm_StreamflowData_Annual_Max7_Seasonal,file.path(file_Path_Variable_O, "LongTerm_StreamflowData_Annual_Min7_Max7_Min7Seasonal_Max7Seasonal_adjustingseason_step7.rds"))
